...
if (isset($_POST['action']) && $_POST['action'] == 'criar') {
    ...
    error_log("nomedep value: " . $_POST['nomedep']);
    $codesc = $_POST['codesc'];
    $nomedep = $_POST['nomedep'];  // ← ADICIONADO: Capturar nomedep
    $nomesc = $_POST['nomesc'];
    $mun = $_POST['mun'];
    $distr = $_POST['distr'];
    ...
    // ↑ CORRIGIDO: Agora usa $nomedep ao invés de $nomesc na segunda posição
